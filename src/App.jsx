...
const products = [
  ...
  },
  {
    ...
    packageOptions: [
      { label: "經典平衡", price: 350 },
      { label: "香濃堅果", price: 400 },
...
function validateStoreData() {
  ...
  const formulaBlendProductsExist =
    products.filter((product) => product.category === "配方豆專區").length === 1 &&
...
console.assert(products.filter((product) => product.category === "配方豆專區").length === 1, "Formula blend category should contain one grouped product.");
