...
export default function CaobanCoffeeHomepage() {
  ...
  const baseShippingFee = shippingFeesByMethod[pickupMethod] ?? shippingFeesByMethod["7-11 賣貨便"];
  const shippingFee = useMemo(() => (cart.length === 0 ? 0 : freeShippingSubtotal >= 1000 ? 0 : baseShippingFee), [baseShippingFee, cart.length, freeShippingSubtotal]);
